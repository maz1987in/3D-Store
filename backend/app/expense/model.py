...
class Expense(Base):
    ...
    amount = sql.Column(sql.Float, nullable=False, index=True)
    description = sql.Column(sql.Text, nullable=True)
    status = sql.Column(sql.Enum(ExpenseStatusEnum), nullable=False, default=ExpenseStatusEnum.PENDING, index=True)
