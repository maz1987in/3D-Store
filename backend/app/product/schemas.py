...
class ProductCreateSchema(Schema):
    ...
    is_ready_made = fields.Bool(load_default=False)
...
class PrintSettingsSchema(Schema):
    ...
    support_enabled = fields.Bool(load_default=False)
    raft_enabled = fields.Bool(load_default=False)
    brim_enabled = fields.Bool(load_default=False)
